...
f= open("Rina/Rina_messages.txt","r")
...
for line in output_list:
    print(line)
    continue
outF = open("Rina_setup/Rina_full.txt", "w")
for line in output_list:
